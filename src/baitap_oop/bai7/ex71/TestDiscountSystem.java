...
import baitap_oop.bai7.ex71.Visit;

import java.util.Date;

public class TestDiscountSystem {
    public static void main(String[] args) {
        baitap_oop.bai7.ex71.Visit v1 = new baitap_oop.bai7.ex71.Visit("Hai Dang", new Date());
        ...
        baitap_oop.bai7.ex71.Visit v2 = new baitap_oop.bai7.ex71.Visit("Ngoc", new Date());
        ...
        baitap_oop.bai7.ex71.Visit v3 = new Visit("Khách Lẻ", new Date()); // No membership
